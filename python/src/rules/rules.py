...
lookup_table = 'card_transaction_lookup'
master_table = 'card_transactions_master'
...
def verify_postcode(card_id, postcode, transaction_dt):
    """
...
def verify_rules(card_id, member_id, amount, pos_id, postcode, transaction_dt):
    """
    ...
    rule3 = verify_postcode(card_id, postcode, transaction_dt)
